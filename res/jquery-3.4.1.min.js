...
!(function (e, t) {
    ...
    function e() {
      if (u) {
        (s.style.cssText =
          ...
          (u.style.cssText =
            "position:relative;display:flex;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%"),
  ...
  var Ye = /^(none|table(?!-c[ea]).+)/,
    Qe = /^--/,
    Je = { position: "absolute", visibility: "hidden", display: "flex" },
